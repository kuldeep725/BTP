/*************
	number_1e5_5e7.txt       :   37.296s
	number_1e5_7e7.txt			 :	 38.872s

	time sudo perf stat -I100 -M Summary,Frontend,Frontend_Bandwidth,Memory_BW,Memory_Bound,Memory_Lat,Pipeline -x, -o kruskal_xinput_8e7.txt ./kruskal.out 100000 50000000 < input_1e5_5e7.csv 
*************/
